import { Modal, ModalContent, ModalHeader, ModalBody, ModalFooter, Button, Autocomplete, AutocompleteItem, Tabs, Tab, RadioGroup, Radio } from "@nextui-org/react";
                        ...
                        <ModalBody>
                            <section className="relative p-4 border border-gray-300 rounded-lg">
                                ...
                                <div className="flex w-full flex-wrap md:flex-nowrap gap-4 mt-4">
                                    {["Apellido Paterno", "Apellido Materno", "Nombre Completo"].map((label, index) => (
                                        <ReusableInput
                                            key={index}
                                            label={label}
                                            className={index === 2 ? "flex-1 min-w-[200px]" : "flex-1 min-w-[150px]"}
                                        />
                                    ))}
                                </div>

                                <div className="flex w-full flex-wrap md:flex-nowrap gap-4 mt-4">
                                    <ReusableInput label="DNI" className="w-32" />
                                    ...
                                    <ReusableInput label="Número de cuenta" className="flex-1 min-w-[200px]" />
                                </div>
                            </section>
                            ...
                            <section className="relative p-4 border border-gray-300 rounded-lg mt-4">
                                ...
                                <RadioGroup label="Aportante" isRequired>
                                    ...
                                    <div className="flex flex-col gap-4">
                                        {["Contrato", "Copia DNI", "Curriculum Vitae"].map((labelText, index) => (
                                            <RenderFileUpload
                                                key={index}
                                                labelText={labelText}
